...
function findArrayIndex(array, text) {
    ...
    return "-> " + text + " <- " + "¡¡Este personaje no existe!!";
}

console.log(findArrayIndex(mainCharacters, "Han Solo"));
console.log(findArrayIndex(mainCharacters, "Cloud Strife"));
...
let characters = mainCharacters.slice();

console.log(removeItem(characters, "Luke"));
console.log(removeItem(characters, "Cloud Srife"));
console.log(removeItem(characters, "Chewbacca"));